...
export default function App() {
  ...
  const [interval, setInterval] = useState((98 - insuredAge) * 12);
  ...
  const goals = [
    ...
    {
      name: "Legacy",
      investmentInterval: (98 - insuredAge) * 12,
      goal: 5400000
    },
    { name: "Education", investmentInterval: 10 * 12, goal: 800000 },
    { name: "Saving", investmentInterval: 20 * 12, goal: 300000 }
  ];
    ...
    <div className="App">
      ...
      <Box>
        ...
        >
              ...
              onKeyPress={async (e) => {
                if (e.key === "Enter") {
                  ...
                  const i = isFullRange
                    ? investmentInterval
                    : (98 - insuredAge) * 12;
                  const d = await getProjection(premium, i);
          ...
          <Box style={{ padding: "10px", display: "flex" }}>
            <div style={{ width: "30vw" }}>Full range</div>
            <Checkbox
              checked={isFullRange}
              onChange={async (x) => {
                //setSAReduce(!SAReduce);
